...
class Student:
    def __init__(self,root):
        ...
        current_course_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Current Course Informations", font=("times new roman",12,"bold"))
        current_course_frame.place(x=15,y=140, width=760,height=90)
        ...
        dep_combo["values"]=("Select Department","CSE","ECE","Civil","IT","Mechanical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","CS","EE","CV","ME")
        ...
        semester_combo["values"]=("Select Semester","Semester-1","Semester-II","Semester-III","Semester-IV")
        semester_combo.current(0)
        semester_combo.grid(row=1,column=3,padx=2,pady=2,sticky=W)


        # Class student Information Frame
        class_Student_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Class Student Informations", font=("times new roman",12,"bold"))
        class_Student_frame.place(x=15,y=230, width=760,height=420)
        ...
        # Roll No
        rool_no_label=Label(class_Student_frame,text="Roll No.",font=("times new roman",12,"bold"))
        rool_no_label.grid(row=1,column=2,padx=5,pady=5,sticky=W)

        rool_no_entry=Entry(class_Student_frame,textvariable=self.var_roll,width=20,font=("times new roman",12,"bold"))
       ...
       #button Frame
        ...
        img_right=Image.open(r"images\emp6.jpg")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                cap=cv2.VideoCapture(0) # 0 mean laptop camera or give path of camera 
                img_id=0
                while True:
